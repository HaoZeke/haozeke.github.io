...
#+begin_src bash
ERROR: Unable to load dependent library /home/rgoswami/Git/Github/Julia/ChemGP/.pixi/envs/docs/bin/../lib/julia/libopenlibm.so
Message:/home/rgoswami/Git/Github/Julia/ChemGP/.pixi/envs/docs/bin/../lib/julia/libopenlibm.so: cannot enable executable stack as shared object requires: Invalid argument
#+end_src
