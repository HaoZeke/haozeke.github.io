...
#+end_src
However, in the interests of sanity, we will leverage the [[https://ankiweb.net/shared/info/1972239816][Syntax Highlighting Anki plugin]] for managing the actual stylesheets instead of manual edits to each card type.
