...
:EXPORT_HUGO_CATEGORIES: programming
:EXPORT_HUGO_TAGS: tools emacs workflow orgmode
...
* DONE On-boarding for Code in Place
CLOSED: [2020-04-10 Fri 16:01]
:PROPERTIES:
:EXPORT_FILE_NAME: scp-onboarding
:EXPORT_HUGO_CATEGORIES: notes
:EXPORT_HUGO_TAGS: ideas teaching cs106a
:EXPORT_HUGO_CUSTOM_FRONT_MATTER: :toc false :comments true
:END:
** Background
...
* DONE Small Section On-boarding
...
* DONE CS106A Small Group Training
...
* DONE Using Mathematica with Orgmode
...
* TODO Thoughts on Chemical Engineering
:PROPERTIES:
...
** Bibliography
Since I will be using ~org-ref~, it makes no sense to load or work with the ~+biblio~ module at the moment.
** Org-Roam
This is the heart of the workflow, and really what most of the configuration will focus on. For me,
** Deft
** Org-Roam-Bibtex
** Org-Journal
** Org-Protocol
I will only cover the bare minimum relating to the use of ~org-capture~ here, because eventually I intend to handle a lot more cases with [[https://github.com/abo-abo/orca][orca]].
*** Templates
...
#+END_SRC
* DONE Pandoc to Orgmode with Babel
...
* DONE Refactoring Dotfiles For Colemak
...
** Vimium
I use the excellent [[https://vimium.github.io/][vimium]] to make Chrome be a little less annoying. Luckily [[https://github.com/philc/vimium/wiki/colemak][the Wiki]] seems to have a reasonable suggestion for colemak. The basic idea is to migrate from
#+BEGIN_SRC conf
mapkey n j
mapkey N J
mapkey e k
