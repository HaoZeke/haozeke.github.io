...
**** Software
I am particularly proud of my contributions to t
*** Societies
...
*** Mentioning Me
**** Lists
- [[https://developers.google.com/season-of-docs/docs/2020/participants][2020 GSoD (Google Season of Docs) list of successful projects]]
...
- [[https://ucsbcarpentry.github.io/2021-02-18-ucsb-online/][Data Analysis and Visualization in Python for Ecologists]] :: February 18-19, 2021 (instructor)
...
* TODO SymEngine and the Season of Docs :@personal:ramblings:thoughts:
:PROPERTIES:
...
** Meeting the Mentors
** Timelines and Deliverable Goals
** Conclusions
It is difficult to gauge the effect of financial incentives on the quality of code. That analysis and possible rant I'll save for another post. Projects like SymEngine attract very good proposals during incentivized development bursts like the Google Summer of Code; but these contributions tend to rot over time; which makes them of dubious use.

[fn:whydoc] I have a very bad memory, and writing things down mean that I n

* TODO LFortran Intrinsics with C :@programming:workflow:projects:tools:
* TODO Rewriting Dotfiles :@personal:tools:workflow:
:PROPERTIES:
:EXPORT_FILE_NAME: rewrite-dotfiles
:EXPORT_HUGO_CUSTOM_FRONT_MATTER: :toc true :comments true
:END:
#+BEGIN_QUOTE
Notes on migrating from ~dotgit~ to
#+END_QUOTE
** Background
