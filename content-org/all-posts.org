...
\# End:
#+END_SRC
With that, we just need to fire up Anki, and we're off to the races (remove ~\~). The [[https://raw.githubusercontent.com/louietan/anki-editor/master/examples.org][Anki
