...
module, although so it makes more sense to actually write a proper ~Python-C~
...
bad for the function we are considering. Even the well commented hand crafted
