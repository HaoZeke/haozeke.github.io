...
* DONE Project Specific Expressions from Nixpkgs for Sphinx documentation :@programming:tools:nix:workflow:
CLOSED: [2021-02-02 Tue 05:09]
:PROPERTIES:
...
*** Upstream
For completion; the upstream expression is reproduced.
#+begin_src nix
{ lib, stdenv
, fetchFromGitHub
, cmake
