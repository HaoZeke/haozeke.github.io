...
# bat exa fd tealdeer starship sd procs zoxide bliss
#+end_src
*** MicroMamba
We will set up a ~micromamba~ installation to get ~git~ and other base utilities.
#+begin_src bash
...
* TODO F2PY and Netlib
:PROPERTIES:
:EXPORT_FILE_NAME: f2py-netlib
:EXPORT_HUGO_CUSTOM_FRONT_MATTER: :toc true :comments true :link-citations true
:END:
#+begin_quote
On exploring techniques and codebases with ~f2py~
#+end_quote
** Background
...
:END:
#+begin_quote
Computational thermal effects and the Fortran community
#+end_quote
** Background
I shall be spending a week more at the Les Houches
