...
4. [[Remapping Keys for ColemakVIM on MacOS][Remapping Keys for ColemakVIM on MacOS]]
** Keyboard Basics
...
1. [[Switching to Colemak][Switching to Colemak]]
2. [[Refactoring Dotfiles For Colemak][Refactoring Dotfiles For Colemak]]
3. [[Remapping Keys with XKB and KLFC][Remapping Keys with XKB and KLFC]]
4. *Keybindings and MacOS* <-- You are here!
...
1. [[GSoC21 W1: LFortran Kickoff][GSoC21 W1: LFortran Kickoff]]
2. [[GSoC21 W2: LFortran Unraveling][GSoC21 W2: LFortran Unraveling]]
3. *GSoC21 W3: Kind, Characters, and Standards* <-- You are here!
...
10. *GSoC21 W10: LFortran Runtime Library Design* <-- You are here!
** Logistics
...
*** Series
This post is going to be generally expositionary in tone; but the series is also reproduced.
1. [[GSoC21 W1: LFortran Kickoff][GSoC21 W1: LFortran Kickoff]]
...
*** Series
Without intending it to be so, it appears that a series has been established,
though not in strict order, the progression of the standards and their modern
equivalents for Fortran-Python can be traced as seen in:
1. [[NumPy, Meson and ~f2py~][NumPy Meson Fortran]]
...
*** Series
Thoughts relating to interoperability of Fortran with things can be
vaguely collated into the following series.
1. [[NumPy, Meson and ~f2py~][NumPy Meson Fortran]]
2. [[Simple Fortran Derived Types and Python][Simple Fortran Derived Types and Python]]
...
1. [[NumPy, Meson and ~f2py~][NumPy Meson Fortran]]
2. [[Simple Fortran Derived Types and Python][Simple Fortran Derived Types and Python]]
3. [[Exploring ~ISO_C_BINDING~ and type-bound procedures][Exploring ~ISO_C_BINDING~ and type-bound procedures]]
...
2. [[Simple Fortran Derived Types and Python][Simple Fortran Derived Types and Python]]
3. [[Exploring ~ISO_C_BINDING~ and type-bound procedures][Exploring ~ISO_C_BINDING~ and type-bound procedures]]
4. [[Fortran OOP and Python][Fortran OOP and Python]]
5. *Fortran Derived Type Arrays and Python* <-- You are here!
...
#+end_src
***** Wayland notes
- ~caja~ isn't compatible with ~wayland~ out of the box
...
*** Series
This is a series of posts centered around "things to do with old fortran code".
To be very exact, there's only this post, but related articles are:
1. *Handling Legacy Fortran Code* <-- You are here
2. MATLAB bindings for Fortran Libraries through ~C~
3. ~cibuildwheel~ for C++ libraries with thin Python wrappers

The third post lays out design guidelines and build practicalities for C++
...
that projects spin off, but still need rather tighte integration, e.g. ~f2py~
