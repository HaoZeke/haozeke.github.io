...
a {
  &[href^="/"],
  &[href^="https://rgoswami.me"],
  &[href^="#"] {
    border-bottom: #0380ff 0.125em solid;
  }
  &:not(&[href^="/"], &[href^="https://rgoswami.me"], &[href^="#"]) {
...
module. Among other things this had a few side effects:
...
- I could pass variables from ~hugo~ to ~scss~ and from there to ~css~ for attribute selectors (as in [[https://github.com/HaoZeke/hugo-theme-hello-friend-ng-hz/commit/b139e7fce6ce05315ad7bba67d9a997a5a285d96][b139e7f]])
*** CI Updates
...
[params.style]
site_url = "https://rgoswami.me/" # Same as baseurl
#+end_src
