...
*** Remapping Keys
The basic idea is to set a function which executes only when ~hyper:enter()~ is true.
**** Basic Movements
...
:END:
#+begin_quote
Final weekly update for LFortran
#+end_quote
** Background
Serialized update for the [[https://summerofcode.withgoogle.com/projects/#5790375215628288][2021 Google Summer of Code]] under the [[https://fortran-lang.org/][fortran-lang
organization]], mentored by [[https://ondrejcertik.com/][Ondrej Certik]].
...
#+begin_export html
<iframe width="560" height="315" src="https://www.youtube.com/embed/ppB8v_thKHk" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
#+end_export
** Thoughts
