...
:END:
#+BEGIN_QUOTE
Thoughts on and rationale behind leaving QWERTY and touch typing in general. Followed [[https://rgoswami.me/posts/colemak-dots-refactor/][by this post]] on refactoring my Dotfiles.
#+END_QUOTE
...
*update:* I actually ended up refactoring my entire Dotfiles to use more Colemak native bindings, as described [[https://rgoswami.me/posts/colemak-dots-refactor/][in this post]].
** Conclusion
...
#+end_quote
** Background
I have mentioned in the past my customized [[Refactoring Dotfiles For Colemak][Colemak dotfiles]] which I used with [[https://rgoswami.me/posts/remap-keys-xkb-klfc/][a customized keyboard layout]]. Unfortunately, the ~.keylayout~ system of MacOS is far more primitive than the elegant ~klfc~ setup [fn:nothinggood]. For an understanding of what we are trying to get at, the following poorly made video will suffice.
...
1. [[Switching to Colemak][Switching to Colemak]]
2. [[Refactoring Dotfiles For Colemak][Refactoring Dotfiles For Colemak]]
3. [[https://rgoswami.me/posts/remap-keys-xkb-klfc/][Remapping Keys with XKB and KLFC]]
4. *Keybindings and MacOS* <-- You are here!
*** VIM Colemak Extensions
Just as a reminder, my setup (or ~hzColemak~) consists of an augmented VIM workflow, as shown below, and [[https://rgoswami.me/posts/remap-keys-xkb-klfc/][described in my previous post]].
...
*** Reykjavík
- I collaborated closely with the brilliant [[https://ondrejcertik.com/][Dr. Ondřej Čertík]] over the course of both on my [[https://rgoswami.me/posts/symengine-gsod20/][GSoD 2020 long project for SymEngine]] and over [[https://rgoswami.me/posts/gsoc21-fin-reprot/][GSoC 2021 on the LFortran compiler]]
