...
* TODO The State of my Dots :@personal:ramblings:tools:workflow:config:
:PROPERTIES:
...
* TODO GSoC'22: A Triumph for Fortran
* TODO Electronic Structure Library and CECAM
* TODO Talk Supplements for the 6th IHPC Workshop
* TODO TUG 2022 and Burnout
* TODO ~f2py~ and the new UI
* TODO Rethinking the web again
...
#+begin_quote
Leveraging ~nix~ and ~flakes~ in conjunction with ~home-manager~
#+end_quote
** Background
...
local mail.
* TODO Back to ~bash~ :@personal:tools:workflow:
#+begin_quote
