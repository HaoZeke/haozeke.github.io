...
Ondrej. Thanks to a timely reminder from my mentor Ondrej, I managed,
nevertheless, to make some concrete progress working on the compilation of
~dftatom~ modules as well.
*** New Merge Requests
...
*** Additional Tasks
I'd like to make some time to continue exploring the LLVM, not to mention
familiarizing myself with the remainder of the string allocation code.
** Logistics
