...
* TODO GSoC21 W8: LFortran and Backend Values :@notes:gsoc21:fortran:rambling:
:PROPERTIES:
:EXPORT_FILE_NAME: gsoc21-w8
:EXPORT_HUGO_CUSTOM_FRONT_MATTER: :toc true :comments true
:END:
#+begin_quote
Staring into backends and more
#+end_quote
** Background
Serialized update for the [[https://summerofcode.withgoogle.com/projects/#5790375215628288][2021 Google Summer of Code]] under the [[https://fortran-lang.org/][fortran-lang
organization]], mentored by [[https://ondrejcertik.com/][Ondrej Certik]].
...
** Logistics
** Overview
Intrinsic math, values, and more bug hunting all the way.
*** New Merge Requests
...
*** Additional Tasks
** Misc Logs
The splitting of files was harsh work. Took a few hours. Mindless, but really needs precision. Thankfully ~vim~ folds help a whole lot.
** Conclusions
