...
project.
* Revisiting Linux Email :@personal:rant:tools:email:workflow:
:PROPERTIES:
...
making more elegant CLI readers a bit limited.
...
configuration will be present. There are problems though. Constant synchronization is slow and network intensive.
