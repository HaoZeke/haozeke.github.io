...
away from (comp-chem) shop talk. However, I also started a slow spiral into a
long wound out slow burnout, and was struggling with some personal issues (since
resolved, hopefully). This post is harder to write and after-all, SciPyCon was
almost four months ago.  Nevertheless, this is a talk supplements post.
