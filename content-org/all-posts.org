...
Also related, probably, was an issue I noticed while co-working with Ondrej, namely, that my stacktraces were and are a good deal less informative than his. This can be quickly reproduced with:
#+begin_src bash
