...
This calls on a ~deps.nix~ which we shall generate in a manner very reminiscent of the ~shell.nix~ [fn:whybother] as follows:
...
Some variation of this will be considered when appropriate.
**** Clean
