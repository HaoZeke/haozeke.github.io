...
The entire workflow will end up being something like this:
...
~org-roam-bibtex~ [[https://github.com/Zaeph/org-roam-bibtex][or ORB]]. The basic idea is to ensure meaningful templates which
...
- The ~org-ref-notes-function~ simply ensures that, like the ~helm-bibtex~ settings, I expect one file per ~pdf~
...
#+END_QUOTE
** Indexing Notes
This part of the workflow builds on the concepts best known as [[https://www.zettelkasten.de/][Zettelkasten method]]. More details about the philosophy behind ~org-roam~ is [[https://org-roam.readthedocs.io/en/latest/][here]].
*** Org-Roam
...
#+BEGIN_SRC emacs-lisp
 (use-package org-roam-bibtex
  ...
  :config
  (add-hook! 'org-mode (org-roam-bibtex-mode t))
