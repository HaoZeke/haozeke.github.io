...
* TODO Migrating Dots to Chezmoi :@personal:ramblings:tools:workflow:
:PROPERTIES:
:EXPORT_FILE_NAME: mig-dots-chezmoi
:EXPORT_HUGO_CUSTOM_FRONT_MATTER: :toc true :comments true
:END:
#+begin_quote
Notes on migrating dotfiles to Chezmoi
#+end_quote
** Background
Barely two months ago [[Dotfiles from dotgit to bombadil][I wrote about]] moving away from the (now) ~python~ based [[https://github.com/EvanPurkhiser/dots][dots]] to the ~rust~ based [[https://github.com/oknozor/toml-bombadil][toml-bombadil]]. Unfortunately, the structure I backed myself into there was needlessly complicated, and involved manually making entries in the ~bombadil.toml~ file for each sub file. This is a good workflow in principle, since it enforces separation of concerns, but it is rather annoying in practice.
** Chezmoi
[[https://github.com/twpayne/chezmoi/][chezmoi]] is almost an institution in and of itself, with [[https://www.chezmoi.io/][detailed documentation]] and a plethora of users. Rather than go over the features of ~chezmoi~
...
#+END_QUOTE
**** Other Content
- [[https://rgoswami.me/posts/numpy-meson-f2py/][NumPy, Meson and ~f2py~]]
*** Slides
