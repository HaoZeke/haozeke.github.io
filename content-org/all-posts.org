...
# :PROPERTIES:
# :EXPORT_FILE_NAME: revisiting-wayland
# :EXPORT_HUGO_CUSTOM_FRONT_MATTER: :toc true :comments true
# :END:
#+begin_quote
Fluff post about returning to ArchLinux
#+end_quote
** Background
...
Window system to Wayland. At the time, I ended up switching back to Xorg, but I
did want to revisit it. Since I visited home recently and was gifted a [[https://www.lenovo.com/us/en/p/laptops/thinkpad/thinkpadx1/thinkpad-x1-carbon-(6th-gen)/22tp2txx16g][Gen 6
ThinkPad X1 Carbon]], I thought this would be a good time.

Part of this post will be interspersed with generic non-Wayland observations,
but it has been a few years since my last setup and things have changed.
** Networking
The days of ~wifi-menu~ are gone. The new ~iwd~ interface is the newest, swankiest kid on the block [fn:potificate].
** Sway basics
*** High DPI
