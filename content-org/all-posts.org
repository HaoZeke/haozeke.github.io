...
* DONE GSoC21 W4: LFortran, Backends and Bugs :@notes:gsoc21:fortran:rambling:
...
* DONE GSoC21 W5: LFortran Design Details and ~minidftatom~  :@notes:gsoc21:fortran:rambling:
...
* DONE GSoC21 W6: LFortran ASR and Values :@notes:gsoc21:fortran:rambling:
...
* DONE GSoC21 W7: LFortran Workflow Basics :@notes:gsoc21:fortran:rambling:
...
* DONE GSoC21 W8: LFortran Refactors, and Compile Time Evaluations :@notes:gsoc21:fortran:rambling:
...
* DONE GSoC21 W9: LFortran Bug Hunting Bonanza :@notes:gsoc21:fortran:rambling:
...
* DONE GSoC21 W10: LFortran Runtime Library Design :@notes:gsoc21:fortran:rambling:
...
* DONE GSoC21 LFortran and Computational Chemistry :@notes:gsoc21:fortran:rambling:
...
* DONE NumPy, Meson and ~f2py~ :@notes:python:fortran:numpy:f2py:rambling:
...
* DONE Simple Fortran Derived Types and Python :@notes:python:fortran:numpy:f2py:rambling:
...
* TODO F2PY and the Python Packaging Story :@notes:python:rambling:fortran:f2py:
** Background
...
* DONE Exploring ~ISO_C_BINDING~ and type-bound procedures :@notes:fortran:f2py:rambling:
...
* DONE Fortran OOP and Python :@notes:python:fortran:numpy:f2py:rambling:
...
structures in ~Python~. This post will bridge Fortran derived types to their
logically equivalent Python class definitions.
* DONE Types from Fortran to Python via Opaque Pointers :@notes:python:fortran:numpy:f2py:rambling:
...
* DONE Revisiting Wayland for ArchLinux :@notes:rambling:workflow:
...
* TODO Customizing ArchLinux Installation Media
:PROPERTIES:
...
* TODO Laptop setup notes ~btrfs~ subvolumes
