...
sufficient to define it in only within the project.
...
This particular patch changes no headers thankfully. Building kernels takes
around as long as I remember, several hours at the least on an older laptop.
** Conclusions
...
more of my configuration / defaults / every time I get a new machine.
