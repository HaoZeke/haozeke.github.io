...
:EXPORT_HUGO_CATEGORIES: notes
:EXPORT_HUGO_TAGS: ideas teaching
:EXPORT_HUGO_CUSTOM_FRONT_MATTER: :toc false :comments true
:END:
** Background
A few weeks ago, I ended up recording a video for the Stanford Code in Place
...
** On-Boarding
This was very reminiscent of the Carpentries instructor training, which makes
