...
use ~ping $SERVER~ and put that in the ~conf~ file. Any online DNS resolver will
also do the trick, like [[https://www.vedbex.com/dns/socks-us.windscribe.com][this one]].
** Pandora
...
typically used for[fn:howcomemongofree]. Will cover scaling up in another post.
*** Opinions
