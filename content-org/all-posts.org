...
#+end_description
* DONE Site Rationale :@projects:ramblings:explanations:
:PROPERTIES:
...
* TODO Orgmode and Hugo :@projects:tools:emacs:webdev:hugo:
:PROPERTIES:
...
* DONE Switching to Colemak :@notes:workflow:personal:explanations:
:PROPERTIES:
...
* TODO An Orgmode Note Workflow :@notes:ramblings:explanations:
:PROPERTIES:
...
* DONE Refactoring Dotfiles For Colemak :@notes:workflow:programming:personal:
