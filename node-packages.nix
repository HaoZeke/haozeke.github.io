...
let
  sources = {
    ...
    "nanocolors-0.1.8" = {
      ...
      version = "0.1.8";
      src = fetchurl {
        url = "https://registry.npmjs.org/nanocolors/-/nanocolors-0.1.8.tgz";
        sha512 = "R8W1gocKhEZmORW/T0szoJUasfgHCKGV0Oea5ob9Q9Jq5uSyG61l2gVOGVhR9D/poZDj0cRunwkyHcQxTHFZOw==";
      };
    };
    "nanoid-3.1.25" = {
      name = "nanoid";
